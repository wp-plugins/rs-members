...
class RsMembersLibrary2
{
	 ...
	 * @return form control
	 */
	function formcontrol( $name, $type, $value, $selectvalue, $postvalue, $rules, $posttype=0 ){
				
		switch( $type ) {
	
			case "checkbox":
				$selected = ( $value == 'on' ) ? 'checked' : '';				
				$str = "<input name=\"$name\" type=\"$type\" id=\"$name\" " . $selected . " class='cmn-toggle cmn-toggle-round'  />
